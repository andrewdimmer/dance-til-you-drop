...
export const generateDancePose = (calibration: Calibration): Pose => {
  ...
  const rightElbowXY = {
    x:
      rightShoulderXY.x + rightElbowDegLen.len * Math.cos(rightElbowDegLen.rad),
    y:
      rightShoulderXY.y + rightElbowDegLen.len * Math.sin(rightElbowDegLen.rad),
  };
  ...
  const leftAnkleXY = {
    x:
      leftKneeXY.x -
      leftAnkleDegLen.len * Math.cos(-leftAnkleDegLen.rad + leftKneeDegLen.rad),
    y:
      leftKneeXY.y +
      leftAnkleDegLen.len * Math.sin(-leftAnkleDegLen.rad + leftKneeDegLen.rad),
  };
